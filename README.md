...
- **Cyan/Blue**: Bright cyan (`#5CCFE6`) - Functions, classes, headings
- **Green**: Pastel green (`#BAE67E`) - Strings, markdown code
- **Yellow/Orange**: Warm yellow (`#FFD580`) - Classes, attributes, parameters
- **Purple**: Soft purple (`#C3A6FF`) - Keywords, constants
- **Red**: Coral red (`#F95972`) - Errors, badges
